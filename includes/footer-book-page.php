...
<script src="../js/main-scripts.js?v=10"></script>
...
if (isset($_SESSION['user_id'])) {
  ...
  echo '<script src="../js/bookmark-scripts-server.js"></script>';
  echo '<script src="../js/user-settings-server.js"></script>';
    ...
    if ($user) {
        ...
        echo '<script src="../js/bookmark-scripts-client.js"></script>';
        echo '<script src="../js/user-settings-client.js"></script>';
    }
} else {
    echo '<script src="../js/bookmark-scripts-client.js"></script>';
    echo '<script src="../js/user-settings-client.js"></script>';
